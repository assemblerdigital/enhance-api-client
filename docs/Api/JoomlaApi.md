...
$apiInstance = new OpenAPI\Client\Api\JoomlaApi(
...
$new_joomla_user = new \OpenAPI\Client\Model\NewJoomlaUser(); // \OpenAPI\Client\Model\NewJoomlaUser
...
| **new_joomla_user** | [**\OpenAPI\Client\Model\NewJoomlaUser**](../Model/NewJoomlaUser.md)|  | |
...
```php
getJoomlaInfo($org_id, $website_id, $app_id): \OpenAPI\Client\Model\JoomlaInfo
```
...
[**\OpenAPI\Client\Model\JoomlaInfo**](../Model/JoomlaInfo.md)
...
```php
getJoomlaUsers($org_id, $website_id, $app_id): \OpenAPI\Client\Model\JoomlaUsersFullListing
```
...
[**\OpenAPI\Client\Model\JoomlaUsersFullListing**](../Model/JoomlaUsersFullListing.md)
