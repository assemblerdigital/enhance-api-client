...
```php
getCustomerLogins($org_id, $offset, $limit, $sort_order, $sort_by): \OpenAPI\Client\Model\LoginsListing
```
...
```php
getUiPreferences(): \OpenAPI\Client\Model\UiPreferences
```
...
[**\OpenAPI\Client\Model\UiPreferences**](../Model/UiPreferences.md)
...
$new_password = new \OpenAPI\Client\Model\NewPassword(); // \OpenAPI\Client\Model\NewPassword | The new unhashed password to set for the login
...
| **new_password** | [**\OpenAPI\Client\Model\NewPassword**](../Model/NewPassword.md)| The new unhashed password to set for the login | |
...
$new_ui_preferences = new \OpenAPI\Client\Model\NewUiPreferences(); // \OpenAPI\Client\Model\NewUiPreferences
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **new_ui_preferences** | [**\OpenAPI\Client\Model\NewUiPreferences**](../Model/NewUiPreferences.md)|  | |
...
$update_ui_preferences = new \OpenAPI\Client\Model\UpdateUiPreferences(); // \OpenAPI\Client\Model\UpdateUiPreferences
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **update_ui_preferences** | [**\OpenAPI\Client\Model\UpdateUiPreferences**](../Model/UpdateUiPreferences.md)|  | |
