...
```php
cloneWebsite($org_id, $website_clone_request): \OpenAPI\Client\Model\NewResourceUuid
```
...
$org_id = 'org_id_example'; // string | The id of the organization.
$website_clone_request = new \OpenAPI\Client\Model\WebsiteCloneRequest(); // \OpenAPI\Client\Model\WebsiteCloneRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **org_id** | **string**| The id of the organization. | |
| **website_clone_request** | [**\OpenAPI\Client\Model\WebsiteCloneRequest**](../Model/WebsiteCloneRequest.md)|  | |
...
```php
createWebsite($org_id, $new_website, $kind): \OpenAPI\Client\Model\NewResourceUuid
```
...
```php
getDomainWebserverRewrites($domain_id): \OpenAPI\Client\Model\WebServerRewrite[]
```
...
[**\OpenAPI\Client\Model\WebServerRewrite[]**](../Model/WebServerRewrite.md)
...
```php
getScreenshotTimestamp($org_id, $website_id, $domain_id): \OpenAPI\Client\Model\UnixTimestamp
```
...
```php
getWebsiteClone($org_id, $clone_id): \OpenAPI\Client\Model\WebsiteCloneResponse
```
...
[**\OpenAPI\Client\Model\WebsiteCloneResponse**](../Model/WebsiteCloneResponse.md)
...
```php
getWebsiteCloneLog($org_id, $clone_id): \OpenAPI\Client\Model\WebsiteCloneLogEntry[]
```
...
[**\OpenAPI\Client\Model\WebsiteCloneLogEntry[]**](../Model/WebsiteCloneLogEntry.md)
...
```php
getWebsiteClones($org_id): \OpenAPI\Client\Model\WebsiteCloneFullListing
```
...
[**\OpenAPI\Client\Model\WebsiteCloneFullListing**](../Model/WebsiteCloneFullListing.md)
...
```php
getWebsiteWebserverKind($website_id): \OpenAPI\Client\Model\WebserverKind
```
...
$domain_id = 'domain_id_example'; // string | The id of the domain.
$web_server_rewrite = new \OpenAPI\Client\Model\WebServerRewrite(); // \OpenAPI\Client\Model\WebServerRewrite | Rewrite a path to a file
