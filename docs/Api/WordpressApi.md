...
Website WordPress application related endpoints
...
```php
getWordpressInfo($org_id, $website_id, $app_id): \OpenAPI\Client\Model\WordPressInfo
```
...
[**\OpenAPI\Client\Model\WordPressInfo**](../Model/WordPressInfo.md)
