...
Website application related endpoints
...
$website_id = 'website_id_example'; // string | The id of the website.
$persistent_app = new \OpenAPI\Client\Model\PersistentApp(); // \OpenAPI\Client\Model\PersistentApp
...
| ------------- | ------------- | ------------- | ------------- |
| **website_id** | **string**| The id of the website. | |
| **persistent_app** | [**\OpenAPI\Client\Model\PersistentApp**](../Model/PersistentApp.md)|  | |
...
```php
getWebsitePersistentApps($website_id): \OpenAPI\Client\Model\ListedPersistentApp[]
```
...
[**\OpenAPI\Client\Model\ListedPersistentApp[]**](../Model/ListedPersistentApp.md)
...
$website_id = 'website_id_example'; // string | The id of the website.
$app_id = 'app_id_example'; // string | The id of the app.
$update_persistent_app = new \OpenAPI\Client\Model\UpdatePersistentApp(); // \OpenAPI\Client\Model\UpdatePersistentApp
...
| **website_id** | **string**| The id of the website. | |
| **app_id** | **string**| The id of the app. | |
| **update_persistent_app** | [**\OpenAPI\Client\Model\UpdatePersistentApp**](../Model/UpdatePersistentApp.md)|  | |
