...
class ImportersApi
{
    ...
    public function getImportServerDomainsCachedWithHttpInfo($org_id, $server_id, $offset = null, $limit = null, $sort_order = null, $search_domain = null, $sort_by = null, string $contentType = self::contentTypes['getImportServerDomainsCached'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ImportServerDomainsListing' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ImportServerDomainsListing' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ImportServerDomainsListing', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getImportServerPullDomainsWithHttpInfo($org_id, $server_id, string $contentType = self::contentTypes['getImportServerPullDomains'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ImportServerDomainsFullListing' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ImportServerDomainsFullListing' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ImportServerDomainsFullListing', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getImportServerSettingsWithHttpInfo($org_id, $server_id, string $contentType = self::contentTypes['getImportServerSettings'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ImportServerSettings' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ImportServerSettings' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ImportServerSettings', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function listImportServerSettingsWithHttpInfo($org_id, string $contentType = self::contentTypes['listImportServerSettings'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ImportServerSettingsFullListing' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ImportServerSettingsFullListing' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ImportServerSettingsFullListing', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @param  \OpenAPI\Client\Model\TransferUserAccountReqBody $transfer_user_account_req_body transfer_user_account_req_body (optional)
     ...
     * @param  string $server_id The UUID of the server (required)
     * @param  string $user_id The ID of the remote cPanel user (required)
     * @param  \OpenAPI\Client\Model\TransferUserAccountReqBody $transfer_user_account_req_body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transferCPanelUserAccount'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $org_id The id of the organization. (required)
     * @param  string $server_id The UUID of the server (required)
     * @param  \OpenAPI\Client\Model\TransferPleskDomainReqBody $transfer_plesk_domain_req_body transfer_plesk_domain_req_body (optional)
     ...
     * @param  string $org_id The id of the organization. (required)
     * @param  string $server_id The UUID of the server (required)
     * @param  \OpenAPI\Client\Model\TransferPleskDomainReqBody $transfer_plesk_domain_req_body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transferPleskDomain'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
