...
class ServersApi
{
    ...
    public function createServerDomainWithHttpInfo($server_id, $body, string $contentType = self::contentTypes['createServerDomain'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\WebsiteAndDomainUuid' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\WebsiteAndDomainUuid' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\WebsiteAndDomainUuid', []),
     ...
     * @param  string $setting_key A key for updating an existing setting, some known values are - hard_delete_after_secs - letsencrypt_enabled - org_websites_same_server - screenshot_driver_pool_size - screenshot_interval - sged_smtp - smtp_smart_host - website_backup (required)
    ...
    public function getAppcdScreenshotConfigWithHttpInfo($server_id, string $contentType = self::contentTypes['getAppcdScreenshotConfig'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ScreenshotConfig' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ScreenshotConfig' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ScreenshotConfig', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     */
    public function getControlPanelRoleInfo(string $contentType = self::contentTypes['getControlPanelRoleInfo'][0])
    {
        list($response) = $this->getControlPanelRoleInfoWithHttpInfo($contentType);
        return $response;
    }
     ...
     */
    public function getControlPanelRoleInfoWithHttpInfo(string $contentType = self::contentTypes['getControlPanelRoleInfo'][0])
    {
        $request = $this->getControlPanelRoleInfoRequest($contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ControlRoleInfo' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ControlRoleInfo' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getControlPanelRoleInfoAsync(string $contentType = self::contentTypes['getControlPanelRoleInfo'][0])
    {
        return $this->getControlPanelRoleInfoAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getControlPanelRoleInfoAsyncWithHttpInfo(string $contentType = self::contentTypes['getControlPanelRoleInfo'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ControlRoleInfo';
        $request = $this->getControlPanelRoleInfoRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getControlPanelRoleInfoRequest(string $contentType = self::contentTypes['getControlPanelRoleInfo'][0])
    {
    ...
    public function getDatabaseRoleMysqlKindWithHttpInfo($server_id, $mysql_kind = null, string $contentType = self::contentTypes['getDatabaseRoleMysqlKind'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\MysqlKind' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\MysqlKind' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\MysqlKind', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getEmailServerHostnameOverrideWithHttpInfo($server_id, string $contentType = self::contentTypes['getEmailServerHostnameOverride'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\EmailServerHostnameOverride' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\EmailServerHostnameOverride' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\EmailServerHostnameOverride', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\FsQuotaStatus' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\FsQuotaStatus' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\HttpdStatus' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\HttpdStatus' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InstallCmd' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InstallCmd' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    public function getOutboundSpamScanningSettingsWithHttpInfo($server_id, string $contentType = self::contentTypes['getOutboundSpamScanningSettings'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\OutboundSpamScanningSettings' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\OutboundSpamScanningSettings' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\OutboundSpamScanningSettings', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getOwaspRulesVersionWithHttpInfo($server_id, string $contentType = self::contentTypes['getOwaspRulesVersion'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\OwaspVersion' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\OwaspVersion' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\OwaspVersion', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServerDiskUsage' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServerDiskUsage' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\WebsitePhpSettings[]' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\WebsitePhpSettings[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServerGroups' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServerGroups' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    public function getServerHostnameWebsiteWithHttpInfo($server_id, string $contentType = self::contentTypes['getServerHostnameWebsite'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServerHostnameWebsite' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServerHostnameWebsite' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ServerHostnameWebsite', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServerInfo' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServerInfo' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServerIowait' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServerIowait' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServerLoad' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServerLoad' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServerMemoryUsage' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServerMemoryUsage' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    public function getServerModSecurityStatusWithHttpInfo($server_id, string $contentType = self::contentTypes['getServerModSecurityStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ModSecStatus' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ModSecStatus' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ModSecStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServerNetworkInterfaces' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServerNetworkInterfaces' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServerNetworkStats' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServerNetworkStats' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    public function getServerRoleWithHttpInfo($server_id, $role, string $contentType = self::contentTypes['getServerRole'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetServerRole200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetServerRole200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetServerRole200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\RolesInfo' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\RolesInfo' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServerStatsFullListing' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServerStatsFullListing' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServerStatus' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServerStatus' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServerUptime' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServerUptime' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ServersListing' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ServersListing' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\UpgradableSystemPackage' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\UpgradableSystemPackage' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\WebserverKind' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\WebserverKind' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\PhpIni' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\PhpIni' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
     ...
     *
     * @param  string $server_id The UUID of the server (required)
     * @param  \OpenAPI\Client\Model\EmailServerHostnameOverride $email_server_hostname_override Hostname override or null (optional)
     ...
     *
     * @param  string $server_id The UUID of the server (required)
     * @param  \OpenAPI\Client\Model\OutboundSpamScanningSettings $outbound_spam_scanning_settings Outbound spam settings (optional)
     ...
     *
     * @param  string $server_id The UUID of the server (required)
     * @param  float $body body (optional)
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ValidationResult' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ValidationResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
