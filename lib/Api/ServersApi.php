...
class ServersApi
{
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ServerSpecs
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ServerSpecs, HTTP status code, HTTP response headers (array of strings)
     */
    public function getServerSpecsWithHttpInfo($server_id, string $contentType = self::contentTypes['getServerSpecs'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\ServerSpecs',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\OpenAPI\Client\Model\ServerSpecs';
        $request = $this->getServerSpecsRequest($server_id, $contentType);
