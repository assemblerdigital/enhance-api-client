...
class BackupsApi
{
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\DirectoryTreeNode[]
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\DirectoryTreeNode[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebsiteBackupDirectoryTreeWithHttpInfo($org_id, $website_id, $backup_id, $offset = null, string $contentType = self::contentTypes['getWebsiteBackupDirectoryTree'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\DirectoryTreeNode[]',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\OpenAPI\Client\Model\DirectoryTreeNode[]';
        $request = $this->getWebsiteBackupDirectoryTreeRequest($org_id, $website_id, $backup_id, $offset, $contentType);
