...
class BackupsApi
{
     ...
     * @param  BackupStorageKind $storage_kind The storage kind of the requested backup. (optional)
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\BackupDetailed' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\BackupDetailed' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\BackupsFullListing' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\BackupsFullListing' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    public function getWebsiteRestoreStatusWithHttpInfo($org_id, $website_id, $backup_id, string $contentType = self::contentTypes['getWebsiteRestoreStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\RestoreDetailed' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\RestoreDetailed' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\RestoreDetailed', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
