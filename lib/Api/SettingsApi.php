...
class SettingsApi
{
     ...
     *
     * @param  string $name The name of the resource. (required)
     * @param  \OpenAPI\Client\Model\UpdateSettingRequest|null $update_setting_request update_setting_request (required)
     ...
     *
     * @param  string $name The name of the resource. (required)
     * @param  \OpenAPI\Client\Model\UpdateSettingRequest|null $update_setting_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateSetting'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
