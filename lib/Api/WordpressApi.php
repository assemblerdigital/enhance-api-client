...
class WordpressApi
{
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WordPressInfo
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WordPressInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWordpressInfoWithHttpInfo($org_id, $website_id, $app_id, string $contentType = self::contentTypes['getWordpressInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\WordPressInfo',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\OpenAPI\Client\Model\WordPressInfo';
        $request = $this->getWordpressInfoRequest($org_id, $website_id, $app_id, $contentType);
