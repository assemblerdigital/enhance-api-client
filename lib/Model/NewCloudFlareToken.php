...
class NewCloudFlareToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['friendly_name'] === null && !$this->isNullableSetToNull('friendly_name')) {
            $invalidProperties[] = "'friendly_name' is required";
        }
     ...
     * Sets friendly_name
     *
     * @param mixed|null $friendly_name friendly_name
     *
     * @return self
     */
