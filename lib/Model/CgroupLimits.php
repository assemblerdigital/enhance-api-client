...
class CgroupLimits implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['nproc'] === null && !$this->isNullableSetToNull('nproc')) {
            $invalidProperties[] = "'nproc' is required";
        }
        if ($this->container['memory_limit'] === null && !$this->isNullableSetToNull('memory_limit')) {
            $invalidProperties[] = "'memory_limit' is required";
        }
        if ($this->container['iops'] === null && !$this->isNullableSetToNull('iops')) {
            $invalidProperties[] = "'iops' is required";
        }
        if ($this->container['io_bandwidth'] === null && !$this->isNullableSetToNull('io_bandwidth')) {
            $invalidProperties[] = "'io_bandwidth' is required";
        }
        if ($this->container['virtual_cpus'] === null && !$this->isNullableSetToNull('virtual_cpus')) {
            $invalidProperties[] = "'virtual_cpus' is required";
        }
